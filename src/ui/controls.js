...
const LAB_SPEC = [
  { cat: '🍃 Comida y recurso', items: [
    ...
    { k: 'resource.carrionAbsRate', label: 'Ritmo de carroñeo', min: 0, max: 1, step: 0.05, dec: 2, d: 'A qué velocidad vacía un carroñero el cadáver de su celda (× su eficiencia carnívora). Alto = lo consumen de golpe; bajo = picotean poco a poco. Por ahora carroñean los que comen carne (effCarn); más adelante será un eje de dieta propio. Se aplica en vivo.' },
  ]},
